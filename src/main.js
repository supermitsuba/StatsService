...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getNames().subscribe(function (computerNames) {
            _this.tabs = [];
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_metric_data_service_service__WEBPACK_IMPORTED_MODULE_1__["MetricDataService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _vm_chart_vm_chart_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./vm-chart/vm-chart.component */ "./src/app/vm-chart/vm-chart.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _vm_chart_vm_chart_component__WEBPACK_IMPORTED_MODULE_7__["VmChartComponent"]
            ],
            imports: [
...
/***/ "./src/app/services/metric-data-service.service.ts":
/*!*********************************************************!*\
  !*** ./src/app/services/metric-data-service.service.ts ***!
  \*********************************************************/
/*! exports provided: MetricDataService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MetricDataService", function() { return MetricDataService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var MetricDataService = /** @class */ (function () {
    function MetricDataService(http) {
        this.http = http;
        this.baseUrl = "";
    }
    /// {baseUrl}/metrics?type=ip&name=LEDPI&limit=25
    MetricDataService.prototype.getMetric = function (computerName, typeOfMetric, limit) {
        return this.http.get(this.baseUrl + "/metrics?type=" + typeOfMetric + "&name=" + computerName + "&limit=" + limit);
    };
    /// {baseUrl}/metrics/types
    MetricDataService.prototype.getTypes = function () {
        return this.http.get(this.baseUrl + "/metrics/types");
    };
    MetricDataService.prototype.getLastTimestamp = function (computerName) {
        return this.http.get(this.baseUrl + "/metrics/" + computerName + "/lastTimestamp");
    };
    /// {baseUrl}/metrics/names
    MetricDataService.prototype.getNames = function () {
        return this.http.get(this.baseUrl + "/metrics/names");
    };
    MetricDataService = __decorate([
...
/***/ "./src/app/vm-chart/vm-chart.component.css":
/*!*************************************************!*\
  !*** ./src/app/vm-chart/vm-chart.component.css ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/app/vm-chart/vm-chart.component.html":
/*!**************************************************!*\
  !*** ./src/app/vm-chart/vm-chart.component.html ***!
  \**************************************************/
/*! no static exports found */
...
/***/ "./src/app/vm-chart/vm-chart.component.ts":
/*!************************************************!*\
  !*** ./src/app/vm-chart/vm-chart.component.ts ***!
  \************************************************/
/*! exports provided: VmChartComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VmChartComponent", function() { return VmChartComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_metric_data_service_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/metric-data-service.service */ "./src/app/services/metric-data-service.service.ts");
/* harmony import */ var ng2_charts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ng2-charts */ "./node_modules/ng2-charts/index.js");
/* harmony import */ var ng2_charts__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(ng2_charts__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _node_modules_moment_min_moment_with_locales__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../node_modules/moment/min/moment-with-locales */ "./node_modules/moment/min/moment-with-locales.js");
/* harmony import */ var _node_modules_moment_min_moment_with_locales__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_node_modules_moment_min_moment_with_locales__WEBPACK_IMPORTED_MODULE_3__);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var VmChartComponent = /** @class */ (function () {
    ...
    VmChartComponent.prototype.getCPU = function () {
        var _this = this;
        this.service.getMetric(this.name, 'CPU', '25').subscribe(function (metric) {
            var tempData = [];
    ...
    VmChartComponent.prototype.getProcesses = function () {
        var _this = this;
        this.service.getMetric(this.name, 'Number of Processes', '25').subscribe(function (metric) {
            var tempData = [];
            for (var i = metric.length - 1; i >= 0; i--) {
                var item = metric[i];
    ...
    VmChartComponent.prototype.getCPUTemp = function () {
        var _this = this;
        this.service.getMetric(this.name, 'CPU Temperature', '25').subscribe(function (cpuMetric) {
            _this.service.getMetric(_this.name, 'GPU Temperature', '25').subscribe(function (gpuMetric) {
                var tempData = [];
                var tempGPUData = [];
                if (cpuMetric.length < 1)
                    return;
                for (var i = cpuMetric.length - 1; i >= 0; i--) {
                    var item = cpuMetric[i];
                    _this.cpuTempLabel.push(_this.convertDateTime(item.createdTimestamp));
    ...
    VmChartComponent.prototype.getMemory = function () {
        var _this = this;
        this.service.getMetric(this.name, 'memTotal', 25).subscribe(function (totalMetric) {
            _this.service.getMetric(_this.name, 'memFree', 25).subscribe(function (freeMetric) {
                var tempTotal = [];
                var tempUsed = [];
                for (var i = totalMetric.length - 1; i >= 0; i--) {
                    var itemTotal = totalMetric[i];
                    _this.memoryLabel.push(_this.convertDateTime(itemTotal.createdTimestamp));
    ...
    ], VmChartComponent.prototype, "name", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])("tempChart"),
        __metadata("design:type", ng2_charts__WEBPACK_IMPORTED_MODULE_2__["BaseChartDirective"])
    ], VmChartComponent.prototype, "tempChart", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])("processChart"),
        __metadata("design:type", ng2_charts__WEBPACK_IMPORTED_MODULE_2__["BaseChartDirective"])
    ], VmChartComponent.prototype, "processChart", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])("cpuChart"),
        __metadata("design:type", ng2_charts__WEBPACK_IMPORTED_MODULE_2__["BaseChartDirective"])
    ], VmChartComponent.prototype, "cpuChart", void 0);
    __decorate([
    ...
    VmChartComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./vm-chart.component.html */ "./src/app/vm-chart/vm-chart.component.html"),
            styles: [__webpack_require__(/*! ./vm-chart.component.css */ "./src/app/vm-chart/vm-chart.component.css")]
        }),
        __metadata("design:paramtypes", [_services_metric_data_service_service__WEBPACK_IMPORTED_MODULE_1__["MetricDataService"]])
    ], VmChartComponent);
    return VmChartComponent;
}());
...
module.exports = __webpack_require__(/*! /Users/supermitsuba/git/StatsService/client/src/main.ts */"./src/main.ts");
